fun main() {
    ...
    println("Economica tiene más pasajeros que VIP? ${pasajerosEconomica > pasajerosVIP}")
    println("Economica tiene más o igual de pasajeros que VIP? ${pasajerosEconomica >= pasajerosVIP}")
}g