    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Icon(
            _activo ? Icons.flight_takeoff : Icons.flight_land,
            size:  72,
            color: _getIconColor(),
          ),
          ...
          Text(
            _activo ? 'Operación activa' : 'Operación suspendida',
            style: TextStyle(
              fontSize:   15,
          ...
          ElevatedButton.icon(
            ...
            label: Text(_activo ? 'Suspender operación' : 'Reactivar operación'),
          ...
          Opacity(
            ...
            child: Text(
              'Reactivaciones: $_reinicios / $_maxReinicios',
              style: TextStyle(
                fontSize: 13,
          ...
          if (enLimite)
            Padding(
              ...
              child: Text(
                'Límite de reactivaciones alcanzado',
                style: TextStyle(
                  fontSize: 12,
          ...
          if (enLimite)
            Padding(
              ...
              child: TextButton(
                onPressed: _reset,
                child: const Text('Restablecer operación'),
              ),
            ),
        ],
      ),
